...
function setup() {
    ...
    let bus = createImg("images/bus.jpg");
    ...
    bus.position(mouseX, mouseY);

    //lets make this cat move
    //cat.position((200 + a), 500);
    bus.position((200 + a), 500);
...
function bear(){
  let bear = createImg("images/car.jpg");
  bear.size(400,400);
